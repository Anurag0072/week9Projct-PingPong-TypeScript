...
import { Scores, Velocity, random } from "./utils.js";
...
class Game{
    private readonly SPEED = 0.085; // fraction of the screen height thet the paddle moves in one use action 
    ...
    moveBall( velocity: Velocity ){
        ...
        if(
            ballCoord.top <= boardCoord.top || ballCoord.bottom > boardCoord.bottom
        ){
